    ...
    <nav class="navbar navbar-expand-lg px-4 py-4 border-body nav-bar sticky-nav row row-cols-3 container-fluid">
      ...
      <div class=" col-md-2">
        <a class="navbar-brand text-center" href="#">
          <router-link to="/">
            <img src="../../media/images/logo.png" alt="ellarmart-logo" style="min-width: 120px; width: 60%">
          </router-link>
        </a> 
      </div>
      ...
      <div class="col-md-10 ms-auto">
        ...
        <div class="collapse navbar-collapse" id="fixedNavBar">
          <ul class="navbar-nav col-12 fixed-nav">
            ...
            <div class="col-md-10 col-xl-10 d-flex align-items-center justify-content-around">
              <li v-for="category in allCategories" :key="category.title" class="mx-auto">
                <RouterLink class="nav-link" active-class="active" :to="{name:'category',params:{'title':category.route}}">{{ category.title }}</RouterLink>      
              </li>
            </div>
            
            <div class="col-md-2 col-xl-2 d-flex align-items-center ms-auto">              
              <li class="nav-item ms-auto ">
                <a class="nav-link" href="#">
                  <svg data-icon="search" viewBox="0 0 512 512" style="fill: #fbfbfd; width: 3.5rem; min-width: 15px;">
              ...
              <li class="nav-item ms-0">
                  <a class="nav-link" href="#">
                    <button class="btn px-0 py-0 position-relative border-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" :style="`pointer-events:${route.name==='cart_page'? 'none': 'auto'}`">
                      <!-- cart number -->
                        <span class="position-absolute translate-middle badge rounded-pill" style="top: 5px; left: 90%; font-size: 1.5rem; background-color: #d12442;">{{cartItems.length}}</span>
                        <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" style="fill: #fbfbfd; width: 3.5rem; min-width: 15px;">
