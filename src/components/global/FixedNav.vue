...
<template>
<nav class="navbar navbar-expand-lg px-4 py-4 border-body nav-bar sticky-nav row container-fluid">
  <div class="col-2">
    <!-- brand logo -->
    ...
    <div class="col-10 ms-auto">
        ...
        <div class="collapse navbar-collapse" id="fixedNavBar">
          <ul class="navbar-nav second-nav col-12 second-nav">
              ...
              <li class="nav-item ms-0">
                    <a class="nav-link" href="#">
                      <button class="btn px-0 py-0 position-relative" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
                        <!-- cart number -->
                        <span class="position-absolute translate-middle badge rounded-pill" style="top: 5px; left: 90%; font-size: 12px; background-color: #d12442;">5</span>
